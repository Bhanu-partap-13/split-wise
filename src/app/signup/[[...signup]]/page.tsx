...
export default function SignupPage() {
  return (
    <div className="flex min-h-screen bg-deep-navy font-sans text-brand-white">
      ...
      <div className="hidden md:flex md:w-[45%] bg-[#0A0F1E] flex-col justify-between p-16 border-r border-subtle-blue-gray relative overflow-hidden">
        ...
        <div className="my-auto relative z-10 max-w-md">
          <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight text-white mb-6 font-heading">
            Join the smart way to split <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric-blue to-soft-teal">finances.</span>
          </h1>
          <p className="text-brand-gray text-lg mb-10 leading-relaxed">
            Create an account to start sharing bills, balances, and settle-up routes in under three minutes.
          </p>
          ...
          <ul className="space-y-5">
            <li className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-white font-heading">Complete Control</h4>
                <p className="text-sm text-brand-gray">Set up customized splitting weights, split unequal amounts, and log recurring bills.</p>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <div className="w-6 h-6 rounded-full bg-soft-teal/10 border border-soft-teal/30 flex items-center justify-center shrink-0 mt-1">
              ...
              <div>
                <h4 className="font-semibold text-white font-heading">Insightful Analytics</h4>
                <p className="text-sm text-brand-gray">Understand where your money is going with smart categorization and monthly breakdowns.</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      {/* Right Column: Standard Clerk SignUp component */}
